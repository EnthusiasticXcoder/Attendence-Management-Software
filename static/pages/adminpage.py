...
class adminpage:
        ...
        #====================        
                ...
                self.B_import = Button(self.F_side, text='Import Worksheet', font=('Goudy old style', 15,"bold"),bd=0,fg="white",bg="dodgerblue4")
                self.B_import.pack(padx=0, pady=10)
                ...
                self.B_admin = Button(self.F_side, text='Create Admin Login', font=('Goudy old style', 15,"bold"),bd=0,fg="white",bg="dodgerblue4")
                self.B_admin.pack(padx=0, pady=10) 
                
                self.B_user = Button(self.F_side, text='Create User Login', font=('Goudy old style', 15,"bold"),bd=0,fg="white",bg="dodgerblue4")
                self.B_user.pack(padx=0, pady=10)

                self.B_change = Button(self.F_side, text='Change Passward', font=('Goudy old style', 15,"bold"),bd=0,fg="white",bg="dodgerblue4")
                self.B_change.pack(padx=0, pady=10)

                self.B_del = Button(self.F_side, text='Delete Login', font=('Goudy old style', 15,"bold"),bd=0,fg="white",bg="dodgerblue4")
                self.B_del.pack(padx=0, pady=10)
